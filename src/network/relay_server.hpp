...
struct ServerSnapshot {
    std::uint64_t generation{}, transport_bytes_per_second{}, feedback_samples{}, source_admissions{};
    std::chrono::microseconds nominal_interval{}, admission_interval{};
    MediaStats feedback{}, feedback_delta{};
    MediaPacerStats pacer{}; // sent_bytes means paced bytes, not confirmed socket delivery.
