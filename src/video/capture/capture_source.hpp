...
enum class CaptureState { stopped, starting, streaming, stopping, permission_denied, fault };
...
public:
    ...
    [[nodiscard]] virtual std::vector<CaptureMode> enumerate_modes(const std::string& stable_id) = 0;
