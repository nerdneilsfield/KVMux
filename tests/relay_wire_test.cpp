...
void paste_control_contract() {
    ...
    control(w::PasteStatus{1,w::PasteState::executing,2,960,10,w::PasteOutcome::none,w::PasteStatusReason::proof},s,12,28);
    ...
    auto status=*w::encode_control(w::PasteStatus{1,w::PasteState::finished,2,960,960,w::PasteOutcome::completed,w::PasteStatusReason::none},s);
    ...
    check(!w::encode_control(w::PasteExecute{0},c)); check(!w::encode_control(w::PasteCancel{0,w::PasteCancelReason::user},c));
    ...
    bad=*w::encode_control(w::PasteStatus{1,w::PasteState::uploading,0,0,0,w::PasteOutcome::none,w::PasteStatusReason::none},s); bad[13]=1; check(!w::decode_control(bad,s));
